...
Remove-Module fscps.lcs -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\fscps.lcs\fscps.lcs.psd1"
Import-Module "$PSScriptRoot\..\fscps.lcs\fscps.lcs.psm1" -Force
