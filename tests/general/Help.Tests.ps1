...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\fscps.lcs\functions", "$global:testroot\..\fscps.lcs\internal\functions"),
	
	[string]
	$ModuleName = "fscps.lcs",
...
$CommandPath = @(
    "$global:testroot\..\fscps.lcs\functions"
    "$global:testroot\..\fscps.lcs\internal\functions"
)
