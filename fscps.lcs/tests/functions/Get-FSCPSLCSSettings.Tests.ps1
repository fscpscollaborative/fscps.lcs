Describe "Get-FSCPSLCSSettings Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Get-FSCPSLCSSettings).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter SettingsJsonString' {
			$parameter = (Get-Command Get-FSCPSLCSSettings).Parameters['SettingsJsonString']
		...
		It 'Should have the expected parameter SettingsJsonPath' {
			$parameter = (Get-Command Get-FSCPSLCSSettings).Parameters['SettingsJsonPath']
		...
		It 'Should have the expected parameter OutputAsHashtable' {
			$parameter = (Get-Command Get-FSCPSLCSSettings).Parameters['OutputAsHashtable']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Get-FSCPSLCSSettings).Parameters['ProgressAction']
